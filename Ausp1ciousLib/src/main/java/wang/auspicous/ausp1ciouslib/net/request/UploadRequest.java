...
import wang.auspicous.ausp1ciouslib.net.body.UploadProgressRequestBody;
        ...
        if (!params.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (null != entry && null != entry.getKey() && null != entry.getValue()) {
                    parts.add(MultipartBody.Part.createFormData(entry.getKey(), new GsonBuilder().disableHtmlEscaping().create().toJson(entry.getValue())));
                }
            }
        }
