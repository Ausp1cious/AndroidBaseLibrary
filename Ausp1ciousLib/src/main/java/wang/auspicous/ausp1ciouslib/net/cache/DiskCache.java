package wang.auspicous.ausp1ciouslib.net.cache;
...
import wang.auspicous.ausp1ciouslib.net.cache.core.ICache;
import wang.auspicous.ausp1ciouslib.net.subscribe.SimpleSubscribe;
import wang.auspicous.ausp1ciouslib.utils.cryptology.AesUtils;
import wang.auspicous.ausp1ciouslib.utils.cryptology.Md5Utils;
...
public final class DiskCache implements ICache {
    ...
    public void put(String key, Object value, long time) {
        put(key, null != value ? new GsonBuilder().disableHtmlEscaping().create().toJson(value) : null, time);
    }
